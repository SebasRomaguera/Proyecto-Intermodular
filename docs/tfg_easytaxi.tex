...
\begin{titlepage}
    ...
    {\normalsize Versión: UD1A - Primera versión funcional\par}
...
El estado actual del proyecto (versión UD1A) incluye un sistema funcional de gestión de usuarios con registro, login, perfil personalizado y múltiples páginas informativas. Las próximas fases incorporarán geolocalización en tiempo real, sistema de reservas, cálculo de tarifas y mapas interactivos con Leaflet.
...
El modelo de datos actual incluye la entidad \texttt{Usuario}:
...
\subsection{Estado actual del proyecto (Versión UD1A)}

El proyecto se encuentra en su primera versión funcional con las siguientes características implementadas:
...
\subsection{Fase UD1B - Geolocalización y mapas}
...
\begin{enumerate}
    ...
    \item \textbf{Visualización de taxis:}
    \begin{itemize}
        \item Marcadores de taxis disponibles en el mapa.
        \item Actualización en tiempo real de posiciones.
        \item Cálculo de distancias.
    \end{itemize}
\end{enumerate}
...
El desarrollo de EasyTaxi Palma en su fase UD1A ha permitido alcanzar los siguientes logros:
...
\begin{enumerate}
    ...
    \item \textbf{Arquitectura escalable:} Diseño modular que facilita la incorporación de nuevas funcionalidades.
    
    \item \textbf{Interfaz profesional:} Diseño moderno, responsive y multiidioma que proporciona una excelente experiencia de usuario.
    
    \item \textbf{Base sólida:} Estructura del proyecto bien organizada que permite el crecimiento ordenado del sistema.
